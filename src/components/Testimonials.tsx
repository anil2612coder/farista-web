                ...
                <div className="relative max-w-4xl mx-auto">
                    ...
                    <div className="relative">
                        {testimonials.map((testimonial, index) => (
                            ...
                            >
                                <div className="p-8 lg:p-12 rounded-3xl glass gradient-border">
                                    {/* Quote Icon */}
                                    <div className="mb-6">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-purple-600 to-cyan-600 flex items-center justify-center text-2xl">
                                            {testimonial.avatar}
                                        </div>
                                        <div>
